...
* required thematic clojure repo intro quote
...
configuration, and otherwise hacking scripts together on your machine.
...
*** refactor/hone bindings implementation
** Old methods
...
Feel free to create an issue/discussion here, ping me on the clojurians slack,
or pop in on one of my Twitch streams - I'd love to share more about it and show
